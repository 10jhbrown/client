...
// export const fetchLatestFollowingPosts = createAsyncThunk(
//   "followingFeed/fetchLatestFollowingPosts",
//   async ({ page, token }, thunkAPI) => {
//     const response = await getLatestFollowingPosts(page, token);
//     return response.data;
//   }
// );

// export const fetchGreatestFollowingPosts = createAsyncThunk(
//   "followingFeed/fetchGreatestFollowingPosts",
//   async ({ page, token }, thunkAPI) => {
//     const response = await getGreatestFollowingPosts(page, token);
//     return response.data;
//   }
// );
